 ...
 *
 */
public class V4 implements DexFileVisitor {
	protected ClassVisitorFactory cvf;

    /**
     * @param classVisitorFactory
     */
    public V4(ClassVisitorFactory classVisitorFactory) {
    ...
    public DexClassVisitor visit(int access_flags, String className, String superClass, String... interfaceNames) {
            ...
            if (cv == null)
                    return null;
            return new V4ClassAdapter(new TypeNameAdapter(cv), access_flags, className, superClass, interfaceNames);
    }
